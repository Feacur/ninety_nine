...
// vec2
vec2 vec2_set(r32 x, r32 y) { return (vec2){x, y}; }
...
svec2 svec2_set(s32 x, s32 y) { return (svec2){x, y}; }
...
uvec2 uvec2_set(u32 x, u32 y) { return (uvec2){x, y}; }
...
// vec3
vec3 vec3_set(r32 x, r32 y, r32 z) { return (vec3){x, y, z}; }
...
svec3 svec3_set(s32 x, s32 y, s32 z) { return (svec3){x, y, z}; }
...
uvec3 uvec3_set(u32 x, u32 y, u32 z) { return (uvec3){x, y, z}; }
...
// vec4
vec4 vec4_set(r32 x, r32 y, r32 z, r32 w) { return (vec4){x, y, z, w}; }
...
svec4 svec4_set(s32 x, s32 y, s32 z, s32 w) { return (svec4){x, y, z, w}; }
...
uvec4 uvec4_set(u32 x, u32 y, u32 z, u32 w) { return (uvec4){x, y, z, w}; }
